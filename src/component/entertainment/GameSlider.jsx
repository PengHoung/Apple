...
export default function GameSlider() {
    ...
    return (
        <div className="w-full pb-6 overflow-hidden font-sans pt-10">
            <style>{`
                :root {
                    --game-slide-width: 280px;
                    --game-slide-height: 160px;
                }
                @media (min-width: 768px) {
                    :root {
                        --game-slide-width: 430px;
                        --game-slide-height: 240px;
                    }
                }
                    ...
                    >
                        {extendedSlides.map((slide, i) => (
                            <div
                                ...
                                style={{ width: 'var(--game-slide-width)', height: '100%' }}
                            >
                                <div
                                    ...
                                    style={{ height: 'var(--game-slide-height)' }}
                                >
                                    <img
                                        src={slide.smallImg}
                                        alt={slide.title}
